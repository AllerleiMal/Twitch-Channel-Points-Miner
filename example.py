...
login_file = open('login_credentials.txt', 'r')
file_data = login_file.readlines()
...
for line in file_data:
    ...
    username=data[0],
    password=data[1],           # If no password will be provided, the script will ask interactively
